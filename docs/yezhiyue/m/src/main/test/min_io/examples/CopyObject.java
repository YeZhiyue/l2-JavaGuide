...
//
//      {
//        // Create object "my-objectname" in bucket Config.BUCKETS[0] by copying from object
...
//
//      {
//        // Create object "my-objectname" in bucket Config.BUCKETS[0] with SSE-KMS server-side
...
//
//      {
//        // Create object "my-objectname" in bucket Config.BUCKETS[0] with SSE-S3 server-side
//        // encryption by copying from object "my-objectname" in bucket "my-source-bucketname".
//        minioClient.copyObject(
//            CopyObjectArgs.builder()
//                .bucket(Config.BUCKETS[0])
...
//
//      {
//        // Create object "my-objectname" in bucket Config.BUCKETS[0] with SSE-C server-side encryption
...
//
//      {
//        // Create object "my-objectname" in bucket Config.BUCKETS[0] by copying from SSE-C encrypted
...
//
//      {
//        // Create object "my-objectname" in bucket Config.BUCKETS[0] with custom headers conditionally
//        // by copying from object "my-objectname" in bucket "my-source-bucketname".
//        minioClient.copyObject(
//            CopyObjectArgs.builder()
//                .bucket(Config.BUCKETS[0])
